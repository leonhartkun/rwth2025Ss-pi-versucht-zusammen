 ...
 * 人工智能自动下棋
 *
 * @param spielfeld der jetztige spielfeld 目前的棋盘
 * @param aktuellerSpieler aktuellerSpieler 现在的棋手
 * @return true, wenn die programm spielfeld fertige geschrieben hat, sonst false
 */
